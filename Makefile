...
src=history.c shell.c ui.c user.c util.c parser.c # hello.c
obj=$(src:.c=.o)
...
ui.o: ui.h ui.c logger.h history.h user.h
util.o: util.h util.c logger.h 
user.o: user.h user.c logger.h
parser.o: parser.h parser.c logger.h
#hello.o: hello.c 
